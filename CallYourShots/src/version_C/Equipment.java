...
public class Equipment {
  ...
  public Entity[] wear(Entity e){
    if(!e.isWearable()) return new Entity[]{e}; // TODO: null pointer exception when rat was generated?
  ...
  public int getDamage(){
   ...
   // System.out.println(oneHand.getModifiers().getDamage());
    if(oneHand==null&&twoHand==null) return owner.getModifiers().getDamage();// + owner.getStats().getStrength();
 ...
 public Entity[] removeAll(){
  ...
  public Equipment setOwner(Entity owner){
    this.owner = owner;
    return this;
  }
